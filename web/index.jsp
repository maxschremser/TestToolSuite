...
<c:set var="page" scope="session" value="index"/>
      ...
      <div class="box2">
        <div class="pad">
          ...
          <div class="wrapper pad_bot1">
            ...
            <span class="color1">DI (FH) Maximilian Schremser</span><br>
            Project Manager and Project Developer <a href="#">More</a>
          </div>
          <div class="wrapper pad_bot1">
            <figure><img src="images/page1_img3.jpg" alt="" class="left marg_right1"></figure>
            <span class="color1">Luiza Diana Gaitan</span><br>
            Marketing and Testing <a href="#">More</a>
          </div>
        </div>
      </div>
    </article>
